...
REQUIRED_PHRASES = {
    "docs/PLAYABLE_WORLD_TARGET.md": (
        ...
        "Final fullscreen human walking/interacting review",
        "automated playable textured large-terrain gate",
        "human input enabled from startup",
        "fullscreen/player-control behavior",
        "current production-style terrain texture set",
        "must not rely on the tiny G51 16 by 16 checker texture",
        "cannot close P5 GPU/compute acceleration by itself",
    ),
    "docs/ROADMAP.md": (
    ...
    "README.md": (
        ...
        "Final fullscreen human walking/interacting review is appropriate only after the automated playable textured large-terrain gate is clean",
        "human input enabled from startup",
        "current production-style terrain texture set",
        "tiny G51 checker texture",
    ),
    "docs/PRODUCTION_WORLD_TERRAIN_GAP_AUDIT.md": (
        "automated validation-grade compact 2K terrain runtime",
...
def main() -> None:
    ...
    if errors:
        raise SystemExit(1)
    print("WT_VALIDATION_PLAYABLE_WORLD_TARGET_PASS next=post_1_0_backlog")
