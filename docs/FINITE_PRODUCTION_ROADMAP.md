...
This document defines the concrete remaining path from the current G40 state to
Terrain 1.0. It exists so the project does not degrade into an infinite list of
"next useful" tasks.

## Current state

Completed validation track: G0 through G40.
...
The next milestone after G40 is G41. The finish line for this roadmap is G60.
